...
def generate_invoice(id):
    ...
    company_ntn = "1000645"
    company_name = "PetroChemical & Lubricants Co (Pvt) Ltd"
    company_province = "Sindh"
    ...
    qr_data = invoice.invoice_number_fbr
    qr_code = QRCodeImage(qr_data, size=100)
    qr_code.drawOn(c, 50, h)
...
def generate_invoice_original(id):
    invoice = get_object_or_404(Invoice, pk=id)
